...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.MyViewHolder> {
    ...
    public BookmarkAdapter(Context context, ArrayList<Result> mList) {
    ...
    @NonNull
    @Override
    public BookmarkAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BookmarkAdapter.MyViewHolder myViewHolder, int i) {
