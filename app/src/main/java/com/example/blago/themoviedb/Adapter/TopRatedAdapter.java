...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.MyViewHolder> {
    ...
    public TopRatedAdapter(Context context, ArrayList<Result> mList) {
    ...
    @NonNull
    @Override
    public TopRatedAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.movie_item, viewGroup, false);

        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TopRatedAdapter.MyViewHolder myViewHolder, int i) {
